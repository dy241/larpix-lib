...
hw_yaml = "/Users/davidyang/Desktop/larpix-lib/sim/hw_cfg_3x3.yaml"
io_req = ac.AsicGrid(hw_yaml, asic_s)

def main():

        frag_lib = fragment_lib_from_yaml("config/fragments/library.yaml", "larpix_v3")
        raw_network = common.dict_from_yaml("config/hydra/3x3_loop.yaml")
...
open_listen_all = 0x022541391C3DF87E
...
data_pkts = rand_data_pkts(10)
io_req.send_packets(1, data_pkts)
print(io_req.received_packets)
