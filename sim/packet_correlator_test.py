...
asic1_get_us_pkt = 0x822541391C01F033
unmatched_read_pkt = 0x022541391C01F007

pc_reply = asic_grid.send_packets(0, [wrong_set_id, correct_set_id, asic0_set_ds_pkt, asic0_set_us_pkt, asic1_set_id_pkt, asic1_set_ds_pkt, 
                                      asic1_get_id_pkt, asic1_get_id_pkt, asic1_get_us_pkt, unmatched_read_pkt])
